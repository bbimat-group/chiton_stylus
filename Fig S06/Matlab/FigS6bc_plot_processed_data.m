...
% 
% This script plots data underlying panels B and C of Figure S6
%
...
fn_inp = {'FigS6_b_processed.csv','FigS6_c_processed.csv'};
fn_out = 'Fig S6BC';
...
caxis_lims = [0,100; 0, 100; 1, 2.5;0,12; 0, 12; 1, 2.5];
