...
% 
% This script plots data underlying Figure S19
%
...
fn_inp = {'Fig19_Core_dry_processed.csv','Fig19_Stylus_longitudinal_dry.csv','Fig19_Stylus_transversal_wet.csv'};
fn_out = {'Fig 19'};
...
for ii=1:length(fn_inp)
    ...
    plot(xy(:,1,ii),xy(:,2,ii),cstr(ii),'DisplayName',[num2str(conf*100,'%2.0f'),'% conf. ellipse']);
end
%axis square;
